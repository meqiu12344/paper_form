      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="w-full text-center">
            ...
            <p className="mt-4 text-sm text-gray-300">ul. Alfreda Jahna 5a,<br/>54-703 Wrocław</p>
            <p className="mt-3 text-sm text-gray-300">Telefon: <a href="tel:717351284" className="hover:text-white">717351284</a></p>
